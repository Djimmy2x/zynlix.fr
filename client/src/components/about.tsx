        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
          <div className="mb-12 lg:mb-0 animate-fade-in-up">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center p-4 bg-[hsl(var(--light-blue))] dark:bg-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-primary mb-2">99.9%</div>
                <div className="text-sm text-gray-600 dark:text-gray-300">Disponibilité garantie</div>
              </div>
              <div className="text-center p-4 bg-[hsl(var(--light-green))] dark:bg-gray-700 rounded-lg">
                <div className="text-2xl font-bold text-secondary mb-2">30%</div>
                <div className="text-sm text-gray-600 dark:text-gray-300">Réduction des coûts IT</div>
              </div>
            </div>
          </div>
